...
metadata:
  {
    "hello-io": { "emoji": "🧩", "requires": { "anyBins": ["claude", "codex", "opencode", "pi"] } },
  }
---
...
**⚠️ CRITICAL: Never review PRs in HelloIo's own project folder!**
...
8. **NEVER start Codex in ~/.hello-io/** - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/hello-io/** - that's the LIVE HelloIo instance!
...
For long-running background tasks, append a wake trigger to your prompt so HelloIo gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
hello-io system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: hello-io system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
