...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.hello-io/hello-io.json`
...
- The script prints a `MEDIA:` line for HelloIo to auto-attach on supported chat providers.
