/**
 * Twitch channel plugin for HelloIo.
 *
 * Main plugin export combining all adapters (outbound, actions, status, gateway).
 * This is the primary entry point for the Twitch channel integration.
 */

import type { HelloIoConfig } from "hello-io/plugin-sdk/twitch";
import { buildChannelConfigSchema } from "hello-io/plugin-sdk/twitch";
 ...
 * for HelloIo. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<TwitchAccountConfig> = {
  ...
  config: {
    ...
    listAccountIds: (cfg: HelloIoConfig): string[] => listAccountIds(cfg),

    /** Resolve an account config by ID */
    resolveAccount: (cfg: HelloIoConfig, accountId?: string | null): TwitchAccountConfig => {
    ...
    isConfigured: (_account: unknown, cfg: HelloIoConfig): boolean => {
