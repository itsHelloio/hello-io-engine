...
import type { ReplyPayload, HelloIoConfig } from "hello-io/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "hello-io/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as HelloIoConfig;
