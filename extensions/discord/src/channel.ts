import { createScopedChannelConfigBase } from "hello-io/plugin-sdk/compat";
import {
...
} from "hello-io/plugin-sdk/discord";
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). HelloIo adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
