...
import { fetchWithSsrFGuard } from "hello-io/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to HelloIo workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".hello-io", "workspace", "media", "inbound");
 ...
 * Format matches HelloIo's expected attachment structure.
 */
