...
import { createAccountListHelpers, type HelloIoConfig } from "hello-io/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: HelloIoConfig, accountId: string): ZalouserAccountConfig {
