import type {
  ...
  PluginLogger,
} from "hello-io/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "hello-io/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: HelloIoPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: HelloIoPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
