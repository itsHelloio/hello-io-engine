import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "hello-io/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setBlueBubblesDmPolicy(cfg: HelloIoConfig, dmPolicy: DmPolicy): HelloIoConfig {
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your HelloIo gateway URL + webhook path",
