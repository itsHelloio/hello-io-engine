...
import { resolveChannelMediaMaxBytes, type HelloIoConfig } from "hello-io/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: HelloIoConfig; accountId?: string }): string[] {
