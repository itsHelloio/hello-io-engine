...
import { createAccountListHelpers, type HelloIoConfig } from "hello-io/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: HelloIoConfig): ResolvedBlueBubblesAccount[] {
