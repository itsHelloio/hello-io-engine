...
This directory contains the **BlueBubbles external channel plugin** for HelloIo.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `hello-io/plugin-sdk` helpers.
