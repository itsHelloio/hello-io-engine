import type { HelloIoConfig, HelloIoPluginApi } from "hello-io/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: HelloIoConfig): { id: string; name: string } {
