...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "hello-io/plugin-sdk/msteams";
...
import { resolvePreferredHelloIoTmpDir } from "../../../src/infra/tmp-hello-io-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredHelloIoTmpDir(), "msteams-mention-"));
