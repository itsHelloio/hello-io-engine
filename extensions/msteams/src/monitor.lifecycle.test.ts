...
import type { HelloIoConfig, RuntimeEnv } from "hello-io/plugin-sdk/msteams";
...
vi.mock("hello-io/plugin-sdk/msteams", () => ({
...
function createConfig(port: number): HelloIoConfig {
  return {
    channels: {
      msteams: {
        enabled: true,
