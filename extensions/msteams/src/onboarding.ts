import type {
  ...
  WizardPrompter,
  MSTeamsTeamConfig,
} from "hello-io/plugin-sdk/msteams";
import {
  DEFAULT_ACCOUNT_ID,
  formatDocsLink,
...
function setMSTeamsDmPolicy(cfg: HelloIoConfig, dmPolicy: DmPolicy) {
...
function setMSTeamsAllowFrom(cfg: HelloIoConfig, allowFrom: string[]): HelloIoConfig {
