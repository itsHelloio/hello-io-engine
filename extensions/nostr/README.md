...
Nostr DM channel plugin for HelloIo using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to HelloIo. It enables your bot to:
...
# Configure hello-io to use local relay
