...
} from "hello-io/plugin-sdk/account-id";
import type { HelloIoConfig } from "hello-io/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: HelloIoConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: HelloIoConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: HelloIoConfig): string {
