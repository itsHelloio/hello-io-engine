...
import type { HelloIoPluginApi } from "hello-io/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: HelloIoPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<HelloIoPluginApi, "config">;
