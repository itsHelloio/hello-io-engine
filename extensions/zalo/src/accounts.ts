...
import { createAccountListHelpers, type HelloIoConfig } from "hello-io/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: HelloIoConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: HelloIoConfig): ResolvedZaloAccount[] {
