...
import type { HelloIoPluginApi } from "hello-io/plugin-sdk/diffs";
...
describe("diffs tool", () => {
  ...
  beforeEach(async () => {
    rootDir = await fs.mkdtemp(path.join(os.tmpdir(), "hello-io-diffs-tool-"));
...
function createApi(): HelloIoPluginApi {
  return {
    id: "diffs",
    name: "Diffs",
    description: "Diffs",
    ...
    runtime: {} as HelloIoPluginApi["runtime"],
    logger: {
      info() {},
      warn() {},
      error() {},
