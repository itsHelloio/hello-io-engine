...
import { isSecretRef } from "hello-io/plugin-sdk/googlechat";
import { createAccountListHelpers, type HelloIoConfig } from "hello-io/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: HelloIoConfig): ResolvedGoogleChatAccount[] {
