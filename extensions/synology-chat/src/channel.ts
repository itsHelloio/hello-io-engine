/**
 * Synology Chat Channel Plugin for HelloIo.
 *
...
} from "hello-io/plugin-sdk/synology-chat";
import { z } from "zod";
...
export function createSynologyChatPlugin() {
  return {
    ...
    meta: {
      ...
      blurb: "Connect your Synology NAS Chat to HelloIo",
      order: 90,
    },
    ...
    pairing: {
      ...
      notifyApproval: async ({ cfg, id }: { cfg: any; id: string }) => {
        ...
        await sendMessage(
          account.incomingUrl,
          "HelloIo: your access has been approved.",
          id,
