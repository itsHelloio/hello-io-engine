import type { HelloIoConfig, PluginRuntime, ResolvedLineAccount } from "hello-io/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: HelloIoConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: HelloIoConfig; accountId: string }): Promise<{
