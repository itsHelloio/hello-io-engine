import type { LineChannelData, HelloIoPluginApi, ReplyPayload } from "hello-io/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: HelloIoPluginApi): void {
  api.registerCommand({
    name: "card",
