---
summary: "Use Qianfan's unified API to access many models in HelloIo"
read_when:
...
3. HelloIo installed on your system
...
4. Copy the API key for use with HelloIo

## CLI setup

```bash
hello-io onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [HelloIo Configuration](/gateway/configuration)
