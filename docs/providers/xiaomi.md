---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with HelloIo"
read_when:
  - You want Xiaomi MiMo models in HelloIo
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). HelloIo uses
