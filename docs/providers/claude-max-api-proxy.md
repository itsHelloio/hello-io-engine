...
You can point HelloIo at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or HelloIo
...
- [Anthropic provider](/providers/anthropic) - Native HelloIo integration with Claude setup-token or API keys
