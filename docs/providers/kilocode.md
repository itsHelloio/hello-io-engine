---
summary: "Use Kilo Gateway's unified API to access many models in HelloIo"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in HelloIo
---
...
```bash
hello-io onboard --kilocode-api-key <key>
```
...
HelloIo dynamically discovers available models from the Kilo Gateway at startup. Use
