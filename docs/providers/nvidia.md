---
summary: "Use NVIDIA's OpenAI-compatible API in HelloIo"
read_when:
  - You want to use NVIDIA models in HelloIo
...
hello-io onboard --auth-choice skip
hello-io models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
