---
summary: "Use Qwen OAuth (free tier) in HelloIo"
read_when:
  - You want to use Qwen with HelloIo
...
If you already logged in with the Qwen Code CLI, HelloIo will sync credentials
