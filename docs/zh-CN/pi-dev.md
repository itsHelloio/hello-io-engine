...
本指南总结了在 HelloIo 中开发 Pi 集成的合理工作流程。
...
状态存储在 HelloIo 状态目录下。默认为 `~/.hello-io`。如果设置了 `HELLO_IO_STATE_DIR`，则使用该目录。
...
- https://docs.hello-io.ai/testing
- https://docs.hello-io.ai/start/getting-started
