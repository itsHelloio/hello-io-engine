...
read_when:
  - You are building a HelloIo plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (hello-io.plugin.json)

Every plugin **must** ship a `hello-io.plugin.json` file in the **plugin root**.
HelloIo uses this manifest to validate configuration **without executing plugin
