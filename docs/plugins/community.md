...
read_when:
  - You want to publish a third-party HelloIo plugin
...
This page tracks high-quality **community-maintained plugins** for HelloIo.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `hello-io plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `hello-io plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect HelloIo to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/hello-io-wechat`
  repo: `https://github.com/icesword0760/hello-io-wechat`
  install: `hello-io plugins install @icesword760/hello-io-wechat`
