...
read_when:
  ...
  - Wiring external systems into HelloIo
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your HelloIo config directory (typically `~/.hello-io/hooks/transforms`).
...
- `hello-io webhooks gmail setup` writes `hooks.gmail` config for `hello-io webhooks gmail run`.
