...
hello-io system heartbeat last
hello-io logs --follow
hello-io config get agents.defaults.heartbeat
hello-io channels status --probe
```
...
```bash
hello-io config get agents.defaults.heartbeat.activeHours
hello-io config get agents.defaults.heartbeat.activeHours.timezone
hello-io config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
hello-io cron list
hello-io logs --follow
```
