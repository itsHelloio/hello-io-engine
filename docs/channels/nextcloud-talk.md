...
```bash
hello-io plugins install @hello-io/nextcloud-talk
```

Local checkout (when running from a git repo):

```bash
hello-io plugins install ./extensions/nextcloud-talk
```
...
2. On your Nextcloud server, create a bot:
   ...
   ```bash
   ./occ talk:bot:install "HelloIo" "<shared-secret>" "<webhook-url>" --feature reaction
   ```
...
- Approve via:
  - `hello-io pairing list nextcloud-talk`
  - `hello-io pairing approve nextcloud-talk <CODE>`
