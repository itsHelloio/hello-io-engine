...
read_when:
  ...
  - Reviewing HelloIo security posture
title: "Pairing"
---

# Pairing

“Pairing” is HelloIo’s explicit **owner approval** step.
...
Stored under `~/.hello-io/credentials/`:
...
3. On your phone, open the HelloIo iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `hello-io nodes pending/approve`) is a
