---
summary: "Synology Chat webhook setup and HelloIo config"
read_when:
  - Setting up Synology Chat with HelloIo
...
```bash
hello-io plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your HelloIo gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in HelloIo.
...
- Pairing approvals work with:
  - `hello-io pairing list synology-chat`
  - `hello-io pairing approve synology-chat <CODE>`
...
```bash
hello-io message send --channel synology-chat --target 123456 --text "Hello from HelloIo"
hello-io message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
