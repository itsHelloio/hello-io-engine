---
summary: "Overview of HelloIo onboarding options and flows"
read_when:
...
HelloIo supports multiple onboarding paths depending on where the Gateway runs
...
- [`hello-io onboard` command](/cli/onboard)

## macOS app onboarding

Use the HelloIo app when you want a fully guided setup on macOS. Docs:
