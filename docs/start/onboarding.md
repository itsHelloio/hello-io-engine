---
summary: "First-run onboarding flow for HelloIo (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give HelloIo">
...
<Step title="CLI">
  ...
  The app can install the global `hello-io` CLI via npm/pnpm so terminal
