...
HelloIo ships three update channels:
...
When you **explicitly** switch channels with `--channel`, HelloIo also aligns
the install method:
...
When you switch channels with `hello-io update`, HelloIo also syncs plugin sources:
