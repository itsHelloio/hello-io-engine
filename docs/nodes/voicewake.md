...
HelloIo treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.hello-io/settings/voicewake.json`

Shape:

```json
{ "triggers": ["hello-io", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
