    ...
    await withTempHome(
      async (tempHome) => {
        ...
        const env = {
          ...
          HELLO_IO_TEST_FAST: "1",
        };
        delete env.HELLO_IO_HOME;
        delete env.HELLO_IO_STATE_DIR;
        delete env.HELLO_IO_CONFIG_PATH;
        delete env.VITEST;

        const entry = path.resolve(process.cwd(), "hello-io.mjs");
