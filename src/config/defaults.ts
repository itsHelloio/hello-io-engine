...
function resolveAnthropicDefaultAuthMode(cfg: HelloIoConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: HelloIoConfig): HelloIoConfig {
...
export function applyTalkApiKey(config: HelloIoConfig): HelloIoConfig {
...
export function applyTalkConfigNormalization(config: HelloIoConfig): HelloIoConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: HelloIoConfig): HelloIoConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: HelloIoConfig): HelloIoConfig {
...
export function applyLoggingDefaults(cfg: HelloIoConfig): HelloIoConfig {
...
export function applyContextPruningDefaults(cfg: HelloIoConfig): HelloIoConfig {
...
export function applyCompactionDefaults(cfg: HelloIoConfig): HelloIoConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
