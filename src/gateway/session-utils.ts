...
import { type HelloIoConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: HelloIoConfig): string[] {
...
export function listAgentsForGateway(cfg: HelloIoConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: HelloIoConfig): string {
...
function resolveSessionStoreAgentId(cfg: HelloIoConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: HelloIoConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: HelloIoConfig): GatewaySessionsDefaults {
