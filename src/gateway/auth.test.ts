...
describe("gateway auth", () => {
  ...
  it("resolves token/password from HELLO_IO gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          HELLO_IO_GATEWAY_TOKEN: "env-token",
          HELLO_IO_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides HELLO_IO_GATEWAY_PASSWORD", () => {
