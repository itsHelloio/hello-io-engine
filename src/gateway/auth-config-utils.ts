import type { GatewayAuthConfig, HelloIoConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: HelloIoConfig, password: string): HelloIoConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
