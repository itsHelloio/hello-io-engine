...
export function hasAmbiguousGatewayAuthModeConfig(cfg: HelloIoConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: HelloIoConfig): void {
