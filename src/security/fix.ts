...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof HelloIoConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: HelloIoConfig; env: NodeJS.ProcessEnv }): {
  cfg: HelloIoConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
