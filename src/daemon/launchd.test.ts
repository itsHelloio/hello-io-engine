...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.hello-io.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", HELLO_IO_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("enables, bootstraps, and kickstarts the resolved label", async () => {
    ...
    const label = "ai.hello-io.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.hello-io.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when HELLO_IO_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.hello-io.gateway.plist",
    },
    {
      name: "uses profile-specific label when HELLO_IO_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", HELLO_IO_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.hello-io.jbphoenix.plist",
    },
    {
      name: "prefers HELLO_IO_LAUNCHD_LABEL over HELLO_IO_PROFILE",
      env: {
        HOME: "/Users/test",
        HELLO_IO_PROFILE: "jbphoenix",
        HELLO_IO_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from HELLO_IO_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        HELLO_IO_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty HELLO_IO_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        HELLO_IO_PROFILE: "myprofile",
        HELLO_IO_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.hello-io.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
