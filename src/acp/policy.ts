...
export function isAcpEnabledByPolicy(cfg: HelloIoConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: HelloIoConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: HelloIoConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: HelloIoConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: HelloIoConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: HelloIoConfig, agentId: string): boolean {
