...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: HelloIoConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: HelloIoConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: HelloIoConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: HelloIoConfig }): Promise<void> {
