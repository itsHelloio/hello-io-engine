...
let originalHelloIoTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalHelloIoTestConsole = process.env.HELLO_IO_TEST_CONSOLE;
  process.env.HELLO_IO_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalHelloIoTestConsole === undefined) {
    delete process.env.HELLO_IO_TEST_CONSOLE;
  } else {
    process.env.HELLO_IO_TEST_CONSOLE = originalHelloIoTestConsole;
  }
