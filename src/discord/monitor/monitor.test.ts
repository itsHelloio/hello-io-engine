...
describe("agent components", () => {
  const createCfg = (): HelloIoConfig => ({}) as HelloIoConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/hello-io-sessions-test.json");
  });
