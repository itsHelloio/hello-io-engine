...
export function listWhatsAppAuthDirs(cfg: HelloIoConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: HelloIoConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: HelloIoConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: HelloIoConfig): ResolvedWhatsAppAccount[] {
