...
function mergeSignalAccountConfig(cfg: HelloIoConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: HelloIoConfig): ResolvedSignalAccount[] {
