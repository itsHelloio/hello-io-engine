  ...
  try {
    if (boxes.length > 0) {
      await page.evaluate((labels) => {
        const existing = document.querySelectorAll("[data-hello-io-labels]");
        existing.forEach((el) => el.remove());

        const root = document.createElement("div");
        root.setAttribute("data-hello-io-labels", "1");
        ...
        for (const label of labels) {
          ...
          box.setAttribute("data-hello-io-labels", "1");
          ...
          tag.setAttribute("data-hello-io-labels", "1");
