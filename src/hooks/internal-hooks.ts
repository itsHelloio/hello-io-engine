/**
 * Hook system for HelloIo agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __hello-io_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__hello-io_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
