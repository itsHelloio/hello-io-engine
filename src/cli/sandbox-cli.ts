...
const SANDBOX_EXAMPLES = {
  main: [
    ["hello-io sandbox list", "List all sandbox containers."],
    ["hello-io sandbox list --browser", "List only browser containers."],
    ["hello-io sandbox recreate --all", "Recreate all containers."],
    ["hello-io sandbox recreate --session main", "Recreate a specific session."],
    ["hello-io sandbox recreate --agent mybot", "Recreate agent containers."],
    ["hello-io sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["hello-io sandbox list", "List all sandbox containers."],
    ["hello-io sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["hello-io sandbox recreate --all", "Recreate all containers."],
    ["hello-io sandbox recreate --session main", "Recreate a specific session."],
    ["hello-io sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["hello-io sandbox recreate --browser --all", "Recreate only browser containers."],
    ["hello-io sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["hello-io sandbox explain", "Show effective sandbox config."],
    ["hello-io sandbox explain --session agent:main:main", "Explain a specific session."],
    ["hello-io sandbox explain --agent work", "Explain an agent sandbox."],
    ["hello-io sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.hello-io.ai/cli/sandbox")}\n`,
    )
    .action(() => {
