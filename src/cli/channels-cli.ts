    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["hello-io channels list", "List configured channels and auth profiles."],
          ["hello-io channels status --probe", "Run channel status checks and probes."],
          [
            "hello-io channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["hello-io channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.hello-io.ai/cli/channels",
        )}\n`,
    );
