...
${formatHelpExamples([
  ['hello-io message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'hello-io message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'hello-io message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.hello-io.ai/cli/message")}`,
    )
    .action(() => {
