...
${formatHelpExamples([
  ['hello-io agent --to +15555550123 --message "status update"', "Start a new session."],
  ['hello-io agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'hello-io agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'hello-io agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['hello-io agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.hello-io.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.hello-io.ai/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['hello-io agents set-identity --agent main --name "HelloIo" --emoji "🦞"', "Set name + emoji."],
  ["hello-io agents set-identity --agent main --avatar avatars/hello-io.png", "Set avatar path."],
  [
    "hello-io agents set-identity --workspace ~/.hello-io/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "hello-io agents set-identity --identity-file ~/.hello-io/workspace/IDENTITY.md --agent main",
