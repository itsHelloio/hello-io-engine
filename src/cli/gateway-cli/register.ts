      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["hello-io gateway run", "Run the gateway in the foreground."],
            ["hello-io gateway status", "Show service status and probe reachability."],
            ["hello-io gateway discover", "Find local and wide-area gateway beacons."],
            ["hello-io gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.hello-io.ai/cli/gateway")}\n`,
      ),
  );
