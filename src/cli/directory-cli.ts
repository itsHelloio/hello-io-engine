    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["hello-io directory self --channel slack", "Show the connected account identity."],
          [
            'hello-io directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["hello-io directory groups list --channel discord", "List available groups/channels."],
          [
            "hello-io directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.hello-io.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
