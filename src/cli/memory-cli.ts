    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["hello-io memory status", "Show index and provider status."],
          ["hello-io memory status --deep", "Probe embedding provider readiness."],
          ["hello-io memory index --force", "Force a full reindex."],
          ['hello-io memory search "meeting notes"', "Quick search using positional query."],
          [
            'hello-io memory search --query "deployment" --max-results 20',
            "Limit results for focused troubleshooting.",
          ],
          ["hello-io memory status --json", "Output machine-readable JSON (good for scripts)."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/memory", "docs.hello-io.ai/cli/memory")}\n`,
    );
