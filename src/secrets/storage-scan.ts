...
export function listAuthProfileStorePaths(config: HelloIoConfig, stateDir: string): string[] {
...
export function listAgentModelsJsonPaths(config: HelloIoConfig, stateDir: string): string[] {
