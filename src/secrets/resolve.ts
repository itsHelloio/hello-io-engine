...
function resolveResolutionLimits(config: HelloIoConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: HelloIoConfig): SecretProviderConfig {
