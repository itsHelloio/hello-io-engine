...
export function listChannelMessageActions(cfg: HelloIoConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: HelloIoConfig): boolean {
...
export function supportsChannelMessageCards(cfg: HelloIoConfig): boolean {
