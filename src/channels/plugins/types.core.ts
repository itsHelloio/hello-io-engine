...
export type ChannelAgentToolFactory = (params: { cfg?: HelloIoConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: HelloIoConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
   ...
   */
  listActions?: (params: { cfg: HelloIoConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: HelloIoConfig }) => boolean;
  supportsCards?: (params: { cfg: HelloIoConfig }) => boolean;
