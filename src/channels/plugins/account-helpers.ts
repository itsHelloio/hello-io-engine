...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: HelloIoConfig): string | undefined {
  ...
  function listAccountIds(cfg: HelloIoConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: HelloIoConfig): string {
