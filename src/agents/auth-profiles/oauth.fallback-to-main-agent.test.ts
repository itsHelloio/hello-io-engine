...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveHelloIoAgentDir() returns mainAgentDir
    process.env.HELLO_IO_STATE_DIR = tmpDir;
    process.env.HELLO_IO_AGENT_DIR = mainAgentDir;
