...
async function resolveContext(config: HelloIoConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): HelloIoConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
