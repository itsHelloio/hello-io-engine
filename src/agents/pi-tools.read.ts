...
function resolveAdaptiveReadMaxBytes(options?: HelloIoReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createHelloIoReadTool(base, {
...
export function createHelloIoReadTool(
  base: AnyAgentTool,
  options?: HelloIoReadToolOptions,
): AnyAgentTool {
