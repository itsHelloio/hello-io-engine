...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/hello-io/hello-io/issues/31298
    previousFastTestEnv = process.env.HELLO_IO_TEST_FAST;
  ...
  afterAll(() => {
    if (previousFastTestEnv === undefined) {
      delete process.env.HELLO_IO_TEST_FAST;
      return;
    }
    process.env.HELLO_IO_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // HELLO_IO_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("HelloIo runtime context (internal):");
