...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): HelloIoConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: HelloIoConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: HelloIoConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
