...
function resolveMemoryToolContext(options: { config?: HelloIoConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: HelloIoConfig): MemoryCitationsMode {
