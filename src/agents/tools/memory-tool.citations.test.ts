...
function asHelloIoConfig(config: Partial<HelloIoConfig>): HelloIoConfig {
  return config as HelloIoConfig;
}

function createToolConfig() {
  return asHelloIoConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: HelloIoConfig = createToolConfig()) {
