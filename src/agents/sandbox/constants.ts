...
export const DEFAULT_SANDBOX_IMAGE = "hello-io-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "hello-io-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "hello-io-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "hello-io-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "hello-io-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "hello-io-sandbox-browser";
