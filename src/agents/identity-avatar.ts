...
function resolveAvatarSource(cfg: HelloIoConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: HelloIoConfig, agentId: string): AgentAvatarResolution {
