...
function buildCoreToolGroupMap() {
  ...
  const hello-ioTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInHelloIoGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:hello-io": hello-ioTools,
