...
const CLEANUP_STATE_KEY = Symbol.for("hello-io.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("hello-io.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("hello-io.sessionWriteLockWatchdogState");
