...
export function resolveDefaultAgentWorkspaceDir(
  ...
  const profile = env.HELLO_IO_PROFILE?.trim();
  if (profile && profile.toLowerCase() !== "default") {
    return path.join(home, ".hello-io", `workspace-${profile}`);
  }
  return path.join(home, ".hello-io", "workspace");
}
...
const WORKSPACE_STATE_DIRNAME = ".hello-io";
