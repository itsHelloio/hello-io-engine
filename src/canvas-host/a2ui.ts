...
export const A2UI_PATH = "/__hello-io__/a2ui";

export const CANVAS_HOST_PATH = "/__hello-io__/canvas";

export const CANVAS_WS_PATH = "/__hello-io__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.hello-ioCanvasA2UIAction.postMessage(...)
  // - Android: window.hello-ioCanvasA2UIAction.postMessage(...)
  const handlerNames = ["hello-ioCanvasA2UIAction"];
  ...
  globalThis.HelloIo = globalThis.HelloIo ?? {};
  globalThis.HelloIo.postMessage = postToNode;
  globalThis.HelloIo.sendUserAction = sendUserAction;
  globalThis.hello-ioPostMessage = postToNode;
  globalThis.hello-ioSendUserAction = sendUserAction;
