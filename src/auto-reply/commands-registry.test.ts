...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@hello-io", { botUsername: "hello-io" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@hello-io args", {
        botUsername: "hello-io",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@hello-io: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "hello-io" })).toBe(
      "/help@otherbot",
    );
  });
