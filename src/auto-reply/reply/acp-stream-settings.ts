...
function resolveAcpStreamCoalesceIdleMs(cfg: HelloIoConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: HelloIoConfig): number {
...
export function resolveAcpProjectionSettings(cfg: HelloIoConfig): AcpProjectionSettings {
