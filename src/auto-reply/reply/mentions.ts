...
function resolveMentionPatterns(cfg: HelloIoConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: HelloIoConfig | undefined, agentId?: string): RegExp[] {
