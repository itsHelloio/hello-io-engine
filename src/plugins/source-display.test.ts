...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/hello-io/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/hello-io/extensions",
        global: "/Users/x/.hello-io/extensions",
        workspace: "/Users/x/ws/.hello-io/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.hello-io/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/hello-io/extensions",
        global: "/Users/x/.hello-io/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.hello-io/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/hello-io/extensions",
        global: "/Users/x/.hello-io/extensions",
