...
export const PLUGIN_MANIFEST_FILENAME = "hello-io.plugin.json";
...
// package.json "hello-io" metadata (used for onboarding/catalog)
...
export type HelloIoPackageManifest = {
  extensions?: string[];
...
): HelloIoPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
