...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.HELLO_IO_TTS_PREFS;
      process.env.HELLO_IO_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.HELLO_IO_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: HelloIoConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
