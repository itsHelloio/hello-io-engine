...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: HelloIoConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: HelloIoConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__hello-ioMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__hello-ioMcporterColdStartWarned;
  });
