...
export function applyOpenrouterProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: HelloIoConfig): HelloIoConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: HelloIoConfig): HelloIoConfig {
...
export function applyMoonshotConfig(cfg: HelloIoConfig): HelloIoConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: HelloIoConfig): HelloIoConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: HelloIoConfig): HelloIoConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: HelloIoConfig): HelloIoConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: HelloIoConfig): HelloIoConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: HelloIoConfig): HelloIoConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: HelloIoConfig): HelloIoConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: HelloIoConfig): HelloIoConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: HelloIoConfig): HelloIoConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: HelloIoConfig): HelloIoConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: HelloIoConfig): HelloIoConfig {
...
export function applyQianfanProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: HelloIoConfig): HelloIoConfig {
