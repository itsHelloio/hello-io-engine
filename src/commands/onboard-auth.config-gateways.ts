...
export function applyVercelAiGatewayProviderConfig(cfg: HelloIoConfig): HelloIoConfig {
...
export function applyVercelAiGatewayConfig(cfg: HelloIoConfig): HelloIoConfig {
