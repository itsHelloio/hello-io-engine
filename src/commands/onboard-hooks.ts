...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.hello-io.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("hello-io hooks list")}`,
      `  ${formatCliCommand("hello-io hooks enable <name>")}`,
      `  ${formatCliCommand("hello-io hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
