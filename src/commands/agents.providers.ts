...
function resolveDefaultAccountId(cfg: HelloIoConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: HelloIoConfig): boolean {
...
export function summarizeBindings(cfg: HelloIoConfig, bindings: AgentBinding[]): string[] {
