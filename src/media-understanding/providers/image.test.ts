...
const ensureHelloIoModelsJsonMock = vi.fn(async () => {});
...
vi.mock("../../agents/models-config.js", () => ({
  ensureHelloIoModelsJson: ensureHelloIoModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    expect(ensureHelloIoModelsJsonMock).toHaveBeenCalled();
