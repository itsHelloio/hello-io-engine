...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("hello-io.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: HelloIoConfig): Promise<ContextEngine> {
