...
function mergeIMessageAccountConfig(cfg: HelloIoConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: HelloIoConfig): ResolvedIMessageAccount[] {
