...
# Output:
# - dist/HelloIo.app
# - dist/HelloIo-<version>.zip
# - dist/HelloIo-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.hello-io.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/HelloIo.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/HelloIo-$VERSION.zip"
DMG="$ROOT_DIR/dist/HelloIo-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/HelloIo-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/HelloIo-$VERSION.dSYM.zip"
