...
show_usage() {
    cat << EOF
clawlog - HelloIo Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View HelloIo logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    HelloIo logs flow through the macOS unified log (subsystem: ai.hello-io).
