...
if [[ -z "$version_content" ]]; then
  echo "<h2>HelloIo $VERSION</h2>"
  echo "<p>Latest HelloIo update.</p>"
  echo "<p><a href=\"https://github.com/hello-io/hello-io/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
