...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.hello-io/hello-io.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von hello-io dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
