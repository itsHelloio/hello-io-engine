...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.hello-io/hello-io.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde hello-io dashboard --no-open en tu escritorio.",
    },
    insecure: {
